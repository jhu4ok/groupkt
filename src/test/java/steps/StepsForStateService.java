...
import transfer.statetrans.StateApi;
...
import transfer.statetrans.routers.state.FromFile;


public class StepsForStateService  {

    private final ByCountryState searchByCountryState = new StateApi().getState().getByState();
    private final ByText searchByText = new StateApi().getState().getByText();
